...
void Game::SetupResources(void){
    ...
    resman_.CreateSphereParticles("SphereParticles", 10000);

	// Load texture to be applied to particles
	filename = std::string(MATERIAL_DIRECTORY) + std::string("/particle.png");
...
void Game::SetupScene(void){
    ...
    // Create particles
    game::SceneNode *particles = CreateInstance("ParticleInstance1", "SphereParticles", "ParticleMaterial", "Sparkle");
	game::SceneNode *particles2 = CreateInstance("ParticleInstance2", "SphereParticles", "ParticleMaterial", "Sparkle");
	game::SceneNode *particles3 = CreateInstance("ParticleInstance3", "SphereParticles", "ParticleMaterial", "Sparkle");

	particles->cycleTime = 3.262;
	particles2->SetPosition(glm::vec3(2, 0, 0));
	particles2->cycleTime = 1.622;
	particles2->particleColor = glm::vec3(0.9, 0.4, 0.6);
	particles3->SetPosition(glm::vec3(-2, 0, 0));
	particles2->cycleTime = 2.234;
	particles3->particleColor = glm::vec3(0.2, 0.8, 0.5);
}
